class ZCL_WHI_CONSTRUCTOR_INJECTION definition
  public
  final
  create public .
...
CLASS ZCL_WHI_CONSTRUCTOR_INJECTION IMPLEMENTATION.


  METHOD get_amount_in_coins.
    DATA(cash_provider) = CAST ZIF_WHI_CASH_PROVIDER( NEW ZCL_WHI_CASH_PROVIDER( ) ).
